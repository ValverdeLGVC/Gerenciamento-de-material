...
<html>
    ...
    <body>
        ...
        <div id="divVoltar">
            <a class="volta" href="http://localhost:8080/SILOS/silosView/itensCautelados.jsp"> VOLTAR</a>
        </div>
        ...
        <%
            try {
                ...
                objSilosDAO.ExcluirCautela(objSilosDTO);

            } catch (Exception e) {
                JOptionPane.showMessageDialog(null, "[Erro]: ExcluirCautela", "Erro", JOptionPane.ERROR_MESSAGE);
            }
        %>
    </body>
</html>
